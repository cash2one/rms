...
var config={
	server:	{'hosts':['localhost:9200']},
	_index : 'theegg',
	_types : ['searchasia','cosmopolitan'],
	_type:'searchasia,cosmopolitan'

};
exports.init=function(conf){
	if(client!=undefined) return;
	client=elasticsearch.config(config);
	indexConfig.index=config._index;
	indexConfig.type=config._type;
};
...
exports.queryFlt=function(req,res){
	console.log("queryFlt: %s", req.query.url);
